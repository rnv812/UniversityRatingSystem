...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'educator report',
                'verbose_name_plural': 'educator reports',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'educator report controller',
                'verbose_name_plural': 'educator report controllers',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'educator indicator value',
                'verbose_name_plural': 'educator indicator values',
